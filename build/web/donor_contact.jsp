<%-- 
    Document   : donor_contact
    Created on : 31 Mar, 2018, 3:45:37 PM
    Author     : hp
--%>
<%
...
color:darkgreen;    
    ...
    <center>
        ...
        <h2>Leave a Message for Admin</h2>
      ...
      <div class="row">
        ...
        <div class="form-group">
          <textarea name="message" id="message" name="msg" class="form-control" rows="4" placeholder="Message" required></textarea>
          <p class="help-block text-danger"></p>
        </div>
        <div id="success"></div>
        <button type="button" id="subb1" class="btn btn-default">Send</button>
      </form>
          </div>
    </center>
